...
const PromoCard = ({ image, label, title, link }: { image: string; label: string; title: string; link: string }) => (
  ...
  >
    ...
    <div className="relative z-10 p-4 flex flex-col justify-end h-full">
      <span className="text-xs text-[#7DD3FC] font-bold uppercase tracking-wide [text-shadow:_0_0_8px_rgba(0,0,0,0.9),_0_0_16px_rgba(0,0,0,0.7),_0_1px_3px_rgba(0,0,0,0.8)]">{label}</span>
