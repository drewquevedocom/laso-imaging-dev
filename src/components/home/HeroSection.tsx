...
const PromoCard = ({ image, label, title, link }: { image: string; label: string; title: string; link: string }) => (
  ...
  >
    ...
    <div className="relative z-10 p-4 flex flex-col justify-end h-full">
      <span className="text-xs text-accent font-bold uppercase tracking-wide [text-shadow:_0_1px_3px_rgb(255_255_255_/_80%),_0_2px_6px_rgb(255_255_255_/_60%)]">{label}</span>
