...
const CTScannerCost = () => {
  const guide = getPricingGuide('ct-scanner-cost');
  ...
  const breadcrumbItems = [
    ...
    { name: 'CT Scanner Cost', url: 'https://lasoimaging.com/guides/ct-scanner-cost' },
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="/guides/ct-scanner-cost"
        type="article"
      />
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-8 border-b">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { label: '16-Slice CT', range: '$50K - $150K' },
                { label: '64-Slice CT', range: '$100K - $300K' },
                { label: '128+ Slice CT', range: '$200K - $500K' },
                { label: 'Installation', range: '$30K - $100K' },
              ].map((item) => (
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium">Get a free, personalized CT scanner quote from our experts</span>
              </div>
        ...
        <section className="py-12 bg-muted/50">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl font-bold mb-6">Complete CT Scanner Pricing Reference</h2>
            <Card>
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Find Your CT Scanner?</h2>
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Our experts will help you find the right CT scanner at the best price for your facility.
            </p>
