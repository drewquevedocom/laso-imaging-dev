...
const MobilePETCT = () => {
  const rental = getMobileRental('pet-ct');
  ...
  const breadcrumbItems = [
    ...
    { name: 'Mobile PET/CT', url: 'https://lasoimaging.com/mobile-rentals/pet-ct' },
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="/mobile-rentals/pet-ct"
      />
      ...
      <main className="min-h-screen">
        ...
        <section className="py-6 bg-accent text-accent-foreground">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                <p className="text-lg font-semibold">Full-service PET/CT rental</p>
                <p className="text-sm opacity-90">Radiopharmaceutical coordination and physics support included</p>
              </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-12">
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    * Full-service rates include physics support and radiopharmaceutical coordination. Contact us for a custom quote.
                  </p>
                </div>
              </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">Get Your Mobile PET/CT Quote Today</h2>
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Our team is ready to help you find the right mobile PET/CT solution for your oncology program.
            </p>
