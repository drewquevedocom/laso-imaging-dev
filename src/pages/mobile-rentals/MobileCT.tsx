...
const MobileCT = () => {
  const rental = getMobileRental('ct');
  ...
  const breadcrumbItems = [
    ...
    { name: 'Mobile CT', url: 'https://lasoimaging.com/mobile-rentals/ct' },
  ];
      ...
      <main className="min-h-screen">
        ...
        <section className="py-6 bg-accent text-accent-foreground">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                <p className="text-lg font-semibold">Emergency CT backup needed?</p>
                <p className="text-sm opacity-90">24-hour emergency deployment available</p>
              </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-12">
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    * Rates vary based on slice count, configuration, and rental duration. Contact us for a custom quote.
                  </p>
                </div>
              </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">Get Your Mobile CT Quote Today</h2>
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Our team is ready to help you find the right mobile CT solution for your facility.
            </p>
