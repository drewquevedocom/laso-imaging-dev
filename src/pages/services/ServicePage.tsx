    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl font-bold mb-6 text-center">Where We Provide This Service</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <Link 
                to="/service-areas/california" 
                className="p-4 bg-card border border-border rounded-lg hover:border-accent hover:shadow-md transition-all text-center group"
              >
                <h3 className="font-semibold text-foreground group-hover:text-accent transition-colors">California</h3>
                <p className="text-sm text-muted-foreground">Los Angeles, San Diego, Bay Area</p>
              </Link>
              <Link 
                to="/service-areas/west-coast" 
                className="p-4 bg-card border border-border rounded-lg hover:border-accent hover:shadow-md transition-all text-center group"
              >
                <h3 className="font-semibold text-foreground group-hover:text-accent transition-colors">West Coast</h3>
                <p className="text-sm text-muted-foreground">WA, OR, NV, AZ</p>
              </Link>
              <Link 
                to="/service-areas/nationwide" 
                className="p-4 bg-card border border-border rounded-lg hover:border-accent hover:shadow-md transition-all text-center group"
              >
                <h3 className="font-semibold text-foreground group-hover:text-accent transition-colors">Nationwide</h3>
