...
const WestCoast = () => {
  const area = getServiceArea('west-coast');
  ...
  const breadcrumbItems = [
    ...
    { name: 'West Coast', url: 'https://lasoimaging.com/service-areas/west-coast' },
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="/service-areas/west-coast"
      />
      ...
      <main className="min-h-screen">
        ...
        <section className="py-6 bg-accent text-accent-foreground">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                <p className="text-lg font-semibold">Serving the entire West Coast region</p>
                <p className="text-sm opacity-90">California, Oregon, Washington, Nevada, and Arizona</p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-12">
                  <h2 className="text-2xl font-bold mb-6">Services Available Across the West Coast</h2>
                ...
                <div className="mt-12 bg-accent/10 rounded-xl p-6 border border-accent/20">
                  <h2 className="text-2xl font-bold mb-4">Mobile Imaging Solutions Across the West Coast</h2>
                  <p className="text-muted-foreground mb-6">
                    Need temporary imaging capacity? Our mobile rental fleet serves healthcare facilities throughout the West Coast with rapid deployment.
                  </p>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      {area.states?.map((state) => (
                        <span key={state} className="text-sm bg-muted px-3 py-1 rounded-full">
                          {state}
                        </span>
                      ))}
                    </div>
                ...
                <Card className="bg-accent text-accent-foreground">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-sm opacity-90 mb-4">
                      Ready to discuss your imaging equipment needs on the West Coast?
                    </p>
        ...
        {area.testimonials.length > 0 && (
          <section className="py-16 bg-muted/30">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold mb-8 text-center">What Our West Coast Customers Say</h2>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Work With West Coast Imaging Experts?</h2>
