            ...
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-12 bg-accent/10 rounded-xl p-6 border border-accent/20">
                  <h2 className="text-2xl font-bold mb-4">Mobile Imaging Solutions in California</h2>
                  <p className="text-muted-foreground mb-6">
                    Need temporary imaging capacity? Our mobile rental fleet serves healthcare facilities throughout California with rapid deployment.
                  </p>
