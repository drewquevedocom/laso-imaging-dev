...
Contact our team today for a free, no-obligation consultation and pricing quote tailored to your facility's specific requirements.`,
    ...
    relatedLinks: [
      ...
      { label: '3T MRI Systems', href: '/equipment/3t-mri-systems' },
...
Contact LASO Imaging today for a customized mobile rental quote.`,
    ...
    relatedLinks: [
      { label: 'Mobile MRI Systems', href: '/equipment/mobile-mri-systems' },
      { label: 'Mobile MRI Rental Service', href: '/services/mobile-mri-rental' },
      { label: 'Mobile CT Rental', href: '/mobile-rentals/ct' },
      { label: 'Request Rental Quote', href: '/rentals/request' },
    ],
  },
};
